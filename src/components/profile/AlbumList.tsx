        ...
        >
          ...
          >
            ...
            <div className="space-y-2">
              <h3 className="font-medium text-md line-clamp-1 group-hover:text-black/50 dark:group-hover:text-white/50 transition-colors">
                {album.title}
              </h3>
              <div className="flex items-center gap-2 text-xs text-muted-foreground group-hover:text-black/50 dark:group-hover:text-white/50 transition-colors">
